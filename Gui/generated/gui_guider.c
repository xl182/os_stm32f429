...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_del = true;
    ui->screen_file_del = true;
    ui->screen_serial_del = true;
    ui->screen_paint_del = true;
}
...
void init_keyboard(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->g_kb_top_layer, montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
}
// modified