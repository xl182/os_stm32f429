...
void MX_LTDC_Init(void)
{
  ...
  hltdc.Init.HorizontalSync = 38;
  hltdc.Init.VerticalSync = 2;
  hltdc.Init.AccumulatedHBP = 178;
  hltdc.Init.AccumulatedVBP = 24;
  hltdc.Init.AccumulatedActiveW = 1202;
  hltdc.Init.AccumulatedActiveH = 624;
  hltdc.Init.TotalWidth = 1362;
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  */
    ...
    */
    ...
    HAL_NVIC_SetPriority(LTDC_ER_IRQn, 9, 0);
