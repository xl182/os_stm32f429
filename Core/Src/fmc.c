...
void MX_FMC_Init(void) {
    ...
    uint32_t mode_reg          = (0x0 << 0) | (0x0 << 3) | (0x3 << 4) | (0x0 << 7) | (0x0 << 9);
    cmd.CommandMode            = FMC_SDRAM_CMD_LOAD_MODE;
    cmd.ModeRegisterDefinition = mode_reg;
    HAL_SDRAM_SendCommand(&hsdram1, &cmd, 0x1000);

    HAL_SDRAM_ProgramRefreshRate(&hsdram1, 682);
...
static void HAL_FMC_MspDeInit(void) {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOD, GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_14 | GPIO_PIN_15 |
